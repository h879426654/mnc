...
public class CuConsumeController {
	...
	public Result<IPage<CuConsume>> queryPageList(CuConsume cuConsume, String shopPhone,
		...
		String shopIds = null;
		if (null != shopPhone) {
			QueryWrapper<MallShopAdvert> queryWrapper = new QueryWrapper<>();
			queryWrapper.eq("advert_Phone", shopPhone);
			MallShopAdvert mallShopAdvert = mallShopAdvertMapper.selectOne(queryWrapper);
