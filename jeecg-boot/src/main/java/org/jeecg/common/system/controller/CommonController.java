...
public class CommonController {
    ...
    @Value(value = "${jeecg.path.endpoint}")
    private String endpoint;

    @Value(value = "${jeecg.path.accessKeyId}")
    private String accessKeyId;

    @Value(value = "${jeecg.path.accessKeySecret}")
    private String accessKeySecret;

    @Value(value = "${jeecg.path.bucketName}")
...
//            File file1 = new File("G:/"+savePath);
//            InputStream inputStream = new FileInputStream(file1);
            ...
            String url1 = endpoint.replace("//","//"+bucketName+".")+"/"+ uuid + "/" + fileName;
            dbpath = url1;
