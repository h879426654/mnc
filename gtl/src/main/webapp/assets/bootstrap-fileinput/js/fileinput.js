    ...
    FileInput.prototype = {
        ...
        _initPreviewCache: function () {
            ...
            self.previewCache = {
                ...
                count: function (all) {
                    var result= !!self.previewCache.data && !!self.previewCache.data.content ?
        ...
        _getResizedImage: function (config, counter, numImgs) {
            var self = this, img = $(config.img)[0], width = img.naturalWidth, height = img.naturalHeight, blob,
                ...
                isValidImage = !!(width && height), chkWidth, chbasicseight, canvas = self.imageCanvas, dataURI,
            ...
            chbasicseight = height > maxHeight;
            if (self.resizePreference === 'width') {
                ratio = chkWidth ? maxWidth / width : (chbasicseight ? maxHeight / height : 1);
            } else {
                ratio = chbasicseight ? maxHeight / height : (chkWidth ? maxWidth / width : 1);
            }
            self._resetCanvas();
            width *= ratio;
            height *= ratio;
        ...
        destroy: function () {
            ...
            //removeData 破坏了kendo对象.
            $el.insertBefore($cont).off(ns);
            self.removeData($el);
            $cont.off().remove();
            return $el;
        },
        ...
        refresh: function (options) {
            var self = this, $el = self.$element;
            //fix:刷新方法,清除预览数据.(by yuwenfeng)
            if(self.options.initialPreview){
             self.options.initialPreview=[];
             self.options.initialPreviewConfig=[];
            }
