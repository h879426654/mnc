...
<%@attribute name="_multipart" type="java.lang.String" required="false" rtexprvalue="false"%>
...
<!-- 添加、编辑对话框 -->
<div id="detail_dialog" class="easyui-dialog" data-options="closed:true,modal:true,title:'${_$titleField}'"
 style="width: ${_$widthField}; height: ${_$heightField}; padding: 10px">
 <form action="" id="detail_form" method="post" <c:if test="${not empty _multipart}">enctype="multipart/form-data" </c:if>>
  <jsp:doBody/>
 </form>
</div>