...
public class GeeSdk {
	...
	protected final String apiUrl = "http://yzm.suzhouheli.cn"; // 验证API URL
	protected final String baseUrl = "yzm.suzhouheli.cn";
	 ...
	 * @param privateKey
	 */
	public GeeSdk(String captchaId, String privateKey) {
