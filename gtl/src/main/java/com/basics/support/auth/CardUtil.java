...
public class CardUtil {
	...
	public static void main(String[] args) {
		System.out.println(getAge("42070419910822427X"));
	}
	...
	public static int getAge(String certificateNo) {
		...
		if (flag && certificateNo.length() == 15) {
			return year - Integer.parseInt("19" + certificateNo.substring(6, 8));
		} else if (flag && certificateNo.length() == 18) {
			return year - Integer.parseInt(certificateNo.substring(6, 10));
		}
		return 0;
	}
