...
public class PasswordEncoder {
	...
	/**
	 * 根据密码值返回加密后的密码及盐值,修改密码、重置密码、创建用户等业务时使用, 之后可将返回的加密密码及salt存入数据库中
	 * 
	 * @param password
	 *            用户输入的密码（明码）
	...
	public static void main(String[] args) {
		System.out.println(JSON.toJSON(getEncPasswordAndSalt("123456")));

		System.out.println(checkPassword("TWauyN", "261a27c48e8a44f625d924c97e4330b2", "123456"));
	}
}
