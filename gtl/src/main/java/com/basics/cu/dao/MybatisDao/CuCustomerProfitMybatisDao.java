...
@Repository
public class CuCustomerProfitMybatisDao extends GenericMybatisDaoSupport<CuCustomerProfit> implements CuCustomerProfitDao {

public CuCustomerProfitMybatisDao() {
super();
