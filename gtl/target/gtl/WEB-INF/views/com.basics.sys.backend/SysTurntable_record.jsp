...
<section class="content">
 ...
 <div class="box">
  ...
  <tags:swgrid _loadURL="selectTurntableEveryDay.do">
   [
     {id:'createTime',title:'时间',columnClass:'text-center',hideType:'xs'}
    ,{id:'drawNum',title:'抽奖数',columnClass:'text-center',hideType:'xs'}
    ,{id:'winNum',title:'中奖数',columnClass:'text-center',hideType:'xs'}
   ]</tags:swgrid>
 </div>
 <!-- 表格} -->
</section>
