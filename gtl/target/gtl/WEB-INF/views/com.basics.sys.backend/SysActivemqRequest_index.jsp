...
<tags:form_add_dialog>
  ...
  <tags:form_group _title="消息内容：">
   <input type="text" name="activemqContext" class="form-control" required="required" data-required-msg="消息内容为必填项">
  </tags:form_group>
  <tags:form_group _title="消息描述：">
   <input type="text" name="activemqRemark" class="form-control" required="required" data-required-msg="消息描述为必填项">
  </tags:form_group>
  <tags:form_group _title="创建时间：">
   <input type="text" name="createDate" class="form-control" required="required" data-required-msg="创建时间为必填项">
  </tags:form_group>
</tags:form_add_dialog>
...
<tags:form_view_dialog>
  ...
  <tags:form_group _title="消息内容：">
   <span name="activemqContext"></span>
  </tags:form_group>
  <tags:form_group _title="消息描述：">
   <span name="activemqRemark"></span>
  </tags:form_group>
  <tags:form_group _title="创建时间：">
 ...
 <div class="box">
  ...
  <tags:swgrid>
   [
    ...
    ,{id:'activemqContext',title:'消息内容',columnClass:'text-center',hideType:'xs'}
    ,{id:'activemqRemark',title:'消息描述',columnClass:'text-center',hideType:'xs'}
    ,{id:'createDate',title:'创建时间',columnClass:'text-center',hideType:'xs'}
   ]</tags:swgrid>
 </div>
 <!-- 表格} -->
</section>
