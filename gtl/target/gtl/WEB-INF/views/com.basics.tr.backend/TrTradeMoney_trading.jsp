...
<head>
 ...
 <script type="text/javascript">
  ...
  function cancleTrade(){
	  ...
	  var row = rows[0];
	  var id = row.id;
	  $.post('${contextPath}/backend/tr/trTradeMoney/cancelTrade.do',{id:id},function(data){
  ...
  function finishTrade(){
	  ...
	  $.post('${contextPath}/backend/tr/trTradeMoney/finishTrade.do',{id:id, customerId:customerId},function(data){
		  CrudApp.success('操作成功!');
		  window.location.reload()
	  });
  }
 ...
 <div class="box">
  ...
  <tags:swgrid _loadURL="selectTradeByTrading.do">
   [
    ...
    ,{id:'tradeMatchTime',title:'匹配时间',columnClass:'text-center',hideType:'xs',resolution:formatDate}
    ,{id:'applyTime',title:'审核时间',columnClass:'text-center',hideType:'xs',resolution:formatDate}
    ,{id:'applyStatusName',title:'审核状态状态',columnClass:'text-center',hideType:'xs'}
   ]</tags:swgrid>
 </div>
 <!-- 表格} -->
</section>
