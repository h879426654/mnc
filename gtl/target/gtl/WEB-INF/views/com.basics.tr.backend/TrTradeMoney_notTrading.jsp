...
<div class="modal fade" id="voucher" tabindex="-1" role="dialog" aria-labelledby="voucherLabel">
  <div class="modal-dialog" role="document">
   <div class="modal-content">
    <div class="modal-header">
     ...
     <h4 class="modal-title" id="priceHistoryLabel">交易凭证</h4>
    </div>
 ...
 <div class="box">
  <div class="box-header with-border">
   <tags:form_grid_toolbar_view>
	      ...
	      <span class="glyphicon glyphicon-group"></span> 挂单取消
	     </button>
   </tags:form_grid_toolbar_view>
  </div>
