...
<tags:form_add_dialog>
  <tags:form_group _title="订单详情ID：">
   <input type="text" name="id" class="form-control" required="required" data-required-msg="订单详情ID为必填项">
  </tags:form_group>
  <tags:form_group _title="订单ID：">
   <input type="text" name="orderId" class="form-control" required="required" data-required-msg="订单ID为必填项">
  </tags:form_group>
...
<section class="content">
 ...
 <div class="box">
  ...
  <tags:swgrid>
   [
     {id:'id',title:'订单详情ID',columnClass:'text-center'}
    ,{id:'orderId',title:'订单ID',columnClass:'text-center',hideType:'xs'}
