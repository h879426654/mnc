...
<tags:form_add_dialog>
  <tags:form_group _title="签到ID：">
   <input type="text" name="id" class="form-control" required="required" data-required-msg="签到ID为必填项">
  </tags:form_group>
  ...
  <tags:form_group _title="每人奖励数量（积分）：">
   <input type="text" name="signNum" class="form-control" required="required" data-required-msg="每人奖励数量（积分）为必填项">
  </tags:form_group>
  <tags:form_group _title="签到时间：">
   <input type="text" name="signTime" class="form-control" required="required" data-required-msg="签到时间为必填项">
  </tags:form_group>
...
<tags:form_view_dialog>
  ...
  <tags:form_group _title="每人奖励数量（积分）：">
   <span name="signNum"></span>
  </tags:form_group>
  <tags:form_group _title="签到时间：">
   <span name="signTime"></span>
  </tags:form_group>
  <tags:form_group _title="版本号：">
...
<section class="content">
 ...
 <div class="box">
  ...
  <tags:swgrid>
   [
     {id:'id',title:'签到ID',columnClass:'text-center'}
    ,{id:'customerId',title:'用户ID',columnClass:'text-center',hideType:'xs'}
    ,{id:'signNum',title:'每人奖励数量（积分）',columnClass:'text-center',hideType:'xs'}
    ,{id:'signTime',title:'签到时间',columnClass:'text-center',hideType:'xs'}
