...
<div id="${_id}_web_uploader_image" data-role="webuploader" data-auto=true data-debug=false
 ...
 data-pick="{id:'#${_id}_web_uploader_image',multiple:false,style:''}" data-file-num-limit=1 data-file-size-limit=10240
