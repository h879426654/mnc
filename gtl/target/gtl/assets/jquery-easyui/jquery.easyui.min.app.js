...
(function($){
 ...
 $.fn._size = function(options, parent){
  ...
  function _setSize(target, property, parent, options){
   ...
   var max = $.parser.parseValue('max'+p1, options['max'+p1], parent);// ||
                                                                      // 99999;
...
(function($) {// panel
  ...
  doLayout : function(jq, all) {
   return jq.each(function() {
    ...
    function _25f(_260, type) {
     ...
     var s = $(_260).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible")
 ...
 $.fn.panel.parseOptions = function(_266) {
  ...
  return $.extend({}, $.parser.parseOptions(_266, [ "id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls",
    "bodyCls", "tools", "href", "method", "header", "footer", {
     cache : "boolean",
     fit : "boolean",
     border : "boolean",
     noheader : "boolean"
...
(function($){ // [window]
 ...
 $.fn.window.defaults = $.extend({}, $.fn.panel.defaults, {
  ...
  shadow: true,
  modal: false,
  inline: false, // true to stay inside its parent, false to go on top of all
                 // elements
...
// selectTab(container, getLiIndex(li));
 ...
 /**
  * update tab panel, param has following properties: tab: the tab panel to be
  * updated options: the tab panel options type: the update type, possible
...
// }
 ...
 $.fn.tabs.methods = {
  ...
  scrollBy: function(jq, deltaX){ // scroll the tab header by the specified
                                  // amount of pixels
   return jq.each(function(){
 ...
 $.fn.tabs.defaults = {
  width: 'auto',
  height: 'auto',
  headerWidth: 150, // the tab header width, it is valid only when tabPosition
...
// submenu.insertAfter(target);
 ...
 /**
  * show the menu, the 'param' object has one or more properties: left: the left
  * position to display top: the top position to display menu: the menu to
  * display, if not defined, the 'target menu' is used parent: the parent menu
  * item to align to alignTo: the element object to align to
  */
 ...
 $.fn.menu.methods = {
  ...
  /**
   * set the menu item text param: { target: DOM object, indicate the menu item
...
// name: t.attr('name'),
 ...
 $.fn.menu.defaults = {
  ...
  minWidth: 120,
  itemHeight: 22,
  duration: 100, // Defines duration time in milliseconds to hide when the mouse
                 // leaves the menu.
 ...
 function init(_442) {
  var _443 = $(
    "<span class=\"switchbutton\">" + "<span class=\"switchbutton-inner\">" + "<span class=\"switchbutton-on\"></span>"
      ...
      + "<input class=\"switchbutton-value\" type=\"checkbox\">" + "</span>" + "</span>").insertAfter(_442);
  var t = $(_442);
...
(function($) {// textbox
 ...
 $.fn.textbox.parseOptions = function(_4e3) {
  var t = $(_4e3);
  return $.extend({}, $.fn.validatebox.parseOptions(_4e3), $.parser.parseOptions(_4e3, [ "prompt", "iconCls", "iconAlign", "buttonText",
...
(function($) { // datagrid
 ...
 function _5f7(_5f8, _5f9) {
  ...
  var _5fd = $(
    "<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">"
      ...
      + "<div class=\"datagrid-body\"></div>" + "<div class=\"datagrid-footer\">" + "<div class=\"datagrid-footer-inner\"></div>"
      + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_5f8);
  _5fd.panel({
   doSize : false,
   cls : "datagrid"
  });
 ...
 ;
 var _731 = $.extend({}, _723([ "text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox",
        ...
        if (!$("#datagrid-group-style").length) {
         $("head").append(
           "<style id=\"datagrid-group-style\">"
             + ".datagrid-group{height:25px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;}" + "</style>");
        }
       }
       ;
      }
...
(function($) {
 ...
 function _86c(_86d, _86e) {
  ...
  function _871(tr, _872) {
   $("<tr class=\"treegrid-tr-tree\">" + "<td style=\"border:0px\" colspan=\"" + _872 + "\">" + "<div></div>" + "</td>" + "</tr>")
     .insertAfter(tr);
  }
  ;
 }
   ...
   function _8dd(_8de, _8df, _8e0) {
    ...
    for (var i = 0; i < _8e0.length; i++) {
     ...
     if (row.children && row.children.length) {
      ...
      _8e3.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan=" + (_8da.length + (opts.rownumbers ? 1 : 0))
        + "><div style=\"display:" + v + "\">");
      _8e3 = _8e3.concat(tt);
      _8e3.push("</div></td></tr>");
     }
...
(function($) { // combobox
 ...
 $.fn.combobox.parseOptions = function(_9c3) {
  var t = $(_9c3);
  return $.extend({}, $.fn.combo.parseOptions(_9c3), $.parser.parseOptions(_9c3, [ "valueField", "textField", "groupField", "mode",
    "method", "url" ]));
 };
...
(function($) { // combogrid
 ...
 $.fn.combogrid.parseOptions = function(_a25) {
  var t = $(_a25);
  return $.extend({}, $.fn.combo.parseOptions(_a25), $.fn.datagrid.parseOptions(_a25), $.parser.parseOptions(_a25, [ "idField",
    "textField", "mode" ]));
 };
...
(function($) { // datebox
 function _a26(_a27) {
  ...
  function _a2a(_a31) {
   ...
   var _a33 = $("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>")
     .appendTo(_a32);
   var tr = _a33.find("tr");
   for (var i = 0; i < opts.buttons.length; i++) {
    var td = $("<td></td>").appendTo(tr);
    var btn = opts.buttons[i];
    var t = $("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text) ? btn.text(_a31) : btn.text)
      .appendTo(td);
 ...
 function init(_a77) {
  var _a78 = $(
    "<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"
      ...
      + "<div style=\"clear:both\"></div>" + "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_a77);
  var t = $(_a77);
...
(function($) {
 ...
 /**
  * load form data if data is a URL string type load from remote site, otherwise
   ...
   for ( var name in data) {
    ...
    if (!_checkField(name, val)) {
     if (!_loadBox(name, val)) {
      ...
      form.find('span[name="' + name + '"]').text(val);
     }
    }
   }
 ...
 $.fn.form.defaults = {
  fieldTypes : [ 'combobox', 'combotree', 'combogrid', 'datetimebox', 'datebox', 'combo', 'datetimespinner', 'timespinner',
    'numberspinner', 'spinner', 'slider', 'searchbox', 'numberbox', 'textbox', 'switchbutton' ],
  novalidate : false,
  ajax : true,
  url : null,
  queryParams : {},
