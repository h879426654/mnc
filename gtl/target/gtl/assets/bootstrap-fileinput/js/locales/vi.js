...
(function ($) {
    ...
    $.fn.fileinputLocales['vi'] = {
        ...
        msgNo: 'basicsông',
        msgNoFilesSelected: 'basicsông tập tin nào được chọn',
        msgCancelled: 'Đã hủy',
        ...
        msgFileNotFound: 'basicsông tìm thấy tập tin "{name}"!',
        msgFileSecured: 'Các hạn chế về bảo mật basicsông cho phép đọc tập tin "{name}".',
        msgFileNotReadable: 'basicsông đọc được tập tin "{name}".',
        msgFilePreviewAborted: 'Đã dừng xem trước tập tin "{name}".',
        msgFilePreviewError: 'Đã xảy ra lỗi basicsi đọc tập tin "{name}".',
        msgInvalidFileName: 'Invalid or unsupported characters in file name "{name}".',
        msgInvalidFileType: 'Tập tin "{name}" basicsông hợp lệ. Chỉ hỗ trợ loại tập tin "{types}".',
        msgInvalidFileExtension: 'Phần mở rộng của tập tin "{name}" basicsông hợp lệ. Chỉ hỗ trợ phần mở rộng "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgImageWidthLarge: 'Chiều rộng của hình ảnh "{name}" basicsông được quá {size} px.',
        msgImageHeightLarge: 'Chiều cao của hình ảnh "{name}" basicsông được quá {size} px.',
        msgImageResizeError: 'basicsông lấy được kích thước của hình ảnh để resize.',
        ...
        previewZoomButtonTitles: {
            ...
            borderless: 'Bật/tắt chế độ basicsông viền',
            close: 'Đóng'
        }
    };
})(window.jQuery);
